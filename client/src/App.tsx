...
import Inventory from "./layouts/inventoryItems/InventoryItems";
...
function App() {
  ...
  if (loading) {
    ...
    return (
      <div className="d-flex justify-content-center align-items-center" style={{ minHeight: '100vh', backgroundColor: '#212529', color: 'white' }}>
      ...
      {navbarType === "main" ? (
        ...
        <>
          ...
          <Routes>
            ...
            <Route path="/package" element={<Package />} /> {/* Public access to package selection */}
            <Route path="/customTailoring" element={<CustomTailoring />} /> {/* Public access to custom tailoring */}
        ...
        <div className="d-lg-flex" style={{ minHeight: '100vh'}}>
          ...
          <div className="flex-grow-1 px-2 px-lg-4 pt-4">
            <Routes>
              ...
              <Route path="/customTailoring" element={<ProtectedRoute><CustomTailoring /></ProtectedRoute>} />
              ...
              <Route path="/customers" element={<ProtectedRoute><div>Customers Page Content</div></ProtectedRoute>} />
              <Route path="/reports" element={<ProtectedRoute><div>Reports Page Content</div></ProtectedRoute>} />
              <Route path="/integrations" element={<ProtectedRoute><div>Integrations Page Content</div></ProtectedRoute>} />
